  ...
  const response = await fetch("https://api.openai.com/v1/responses", {
    ...
    body: JSON.stringify({
      ...
      instructions: [
        ...
        "Use selected uploaded reports as clinical evidence together with symptoms, demographics, and follow-up answers.",
        "Disease ranking, score changes, and filtration must be done by the model from symptoms plus selected report evidence; do not copy a deterministic config match.",
        "Generate follow-up questions yourself from symptoms, likely conditions, selected report evidence, demographics, and the configured hints.",
        ...
        "For initial_from_intake, return likely possible conditions from symptoms plus report evidence and ask whether targeted follow-up could improve certainty.",
        "For refine_with_followup_answers, use the provided answers and report evidence to update condition scores, remove weaker possibilities, and ask only new questions if clinically useful.",
          ...
          content: [
            {
              ...
              text: JSON.stringify({
                ...
                selectedReportCount: context.selectedReportCount || 0,
                availableReportCount: context.availableReportCount || 0,
